...
return
    ...
    this.InputIndexUpdate.forEach((product: any) => {
      ...
      if (
        ...
        //console.log(this.packDetails[submitproduct], "product",this.quantities[product],product,"procuse");
        let least = []
        // console.log(this.packDetails[product], this.packDetails[product])
